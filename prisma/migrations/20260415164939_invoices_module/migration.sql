...
ALTER TABLE "Invoices"
  ADD CONSTRAINT "Invoices_createdBy_fkey"
  FOREIGN KEY ("createdBy") REFERENCES "Users"("id")
  ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE "Invoices"
  ADD CONSTRAINT "Invoices_seriesId_fkey"
  FOREIGN KEY ("seriesId") REFERENCES "Invoice_Series"("id")
  ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "Invoices"
  ADD CONSTRAINT "Invoices_accountId_fkey"
  FOREIGN KEY ("accountId") REFERENCES "crm_Accounts"("id")
  ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE "Invoice_LineItems"
  ADD CONSTRAINT "Invoice_LineItems_invoiceId_fkey"
  FOREIGN KEY ("invoiceId") REFERENCES "Invoices"("id")
  ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "Invoice_LineItems"
  ADD CONSTRAINT "Invoice_LineItems_productId_fkey"
  FOREIGN KEY ("productId") REFERENCES "crm_Products"("id")
  ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE "Invoice_LineItems"
  ADD CONSTRAINT "Invoice_LineItems_taxRateId_fkey"
  FOREIGN KEY ("taxRateId") REFERENCES "Invoice_TaxRates"("id")
  ON DELETE SET NULL ON UPDATE CASCADE;
...
ALTER TABLE "Invoice_Activity"
  ADD CONSTRAINT "Invoice_Activity_invoiceId_fkey"
  FOREIGN KEY ("invoiceId") REFERENCES "Invoices"("id")
  ON DELETE CASCADE ON UPDATE CASCADE;
